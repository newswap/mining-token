...
module.exports = async function (deployer, network, accounts) {
  ...
  // const nst_bal2 = await nst.balanceOf(accounts[0])
  // console.log(nst_bal2/1e18)
  const nsp_bal2 = await nsp.balanceOf(accounts[2])
  console.log(nsp_bal2/1e18)
  ...
  // 多了1w nst
  const nst_bal3 = await nst.balanceOf(tokenMineAddress)
  console.log(nst_bal3/1e18)
  // 多10nsp
  const nsp_bal3 = await nsp.balanceOf(accounts[2])
  console.log(nsp_bal3/1e18)

  // TODO 测试加入矿池
  const tokenMine = await TokenMine.at(tokenMineAddress)
  const owner = await tokenMine.owner()
  console.log("tokenMine owner:" +  owner)
